...
- Consulting the [OVHcloud API first steps guide](https://docs.ovh.com/asia/en/api/first-steps-with-ovh-api) to familiarise yourself with the OVHcloud APIv6

## Instructions

> [!primary]
> Please visit the [HA-NAS FAQ page](https://docs.ovh.com/asia/en/storage/faq-nas) for detailed information on the snapshot function.
>
...
[Mount your NAS via NFS share](https://docs.ovh.com/asia/en/storage/nas-nfs)

[Mount your NAS on Windows Server via CIFS](https://docs.ovh.com/asia/en/storage/nas/nas-cifs)
