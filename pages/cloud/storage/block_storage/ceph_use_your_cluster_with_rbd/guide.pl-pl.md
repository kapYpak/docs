---
title: Uzyskaj dostęp do klastra za pomocą klienta rbd (EN)
...
- [Create a pool](https://docs.ovh.com/pl/storage/ceph/create-a-pool)
- [Create a user](https://docs.ovh.com/pl/storage/ceph/create-a-user)
- [Add rights to a user on a pool](https://docs.ovh.com/pl/storage/ceph/change-user-rights)
- [Add an IP ACL](https://docs.ovh.com/pl/storage/ceph/create-an-ip-acl) to allow your server to contact the cluster
