...
- [Prepare the environment to use the OpenStack API](https://docs.ovh.com/au/en/storage/public-cloud/prepare_the_environment_for_using_the_openstack_api) with the python-swiftclient client
- [Setting OpenStack environment variables](https://docs.ovh.com/au/en/storage/public-cloud/set-openstack-environment-variables)
