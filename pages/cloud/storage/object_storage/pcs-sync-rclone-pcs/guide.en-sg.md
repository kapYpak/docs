...
- You need to have created an *Object Storage* container (you can create one from the [Control Panel])(https://docs.ovh.com/sg/en/storage/create_an_object_container/){.external})
