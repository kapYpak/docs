...
- [Prepare the environment to use the OpenStack API](https://docs.ovh.com/ca/en/public-cloud/prepare_the_environment_for_using_the_openstack_api/) by installing python-swiftclient.
- [Load the OpenStack environment variables](https://docs.ovh.com/ca/en/public-cloud/set-openstack-environment-variables/).
...
> See the [Curl command memo](https://docs.ovh.com/ca/en/storage/pca/curl-commands-memo) documentation for the manifest upload.
>
