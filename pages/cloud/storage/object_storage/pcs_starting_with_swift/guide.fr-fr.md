...
Cette URL est composée d'un point de terminaison, disponible à partir de l'[interface Horizon](https://docs.ovh.com/fr/public-cloud/acces-et-securite-dans-horizon), du nom de votre conteneur et du nom de votre objet (y compris le préfixe).
