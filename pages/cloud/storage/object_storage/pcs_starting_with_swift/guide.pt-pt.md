...
- [Preparar o ambiente para utilizar a API OpenStack](https://docs.ovh.com/pt/storage/public-cloud/preparar_o_ambiente_para_utilizar_a_api_openstack) instalando python-swiftclient
- [Carregar as variáveis de ambiente OpenStack](https://docs.ovh.com/pt/storage/public-cloud/carregar-as-variaveis-de-ambiente-openstack)
...
Este URL é composto por um ponto de terminação, disponível a partir da [interface Horizon](https://docs.ovh.com/pt/storage/public-cloud/gestao-a-partir-do-horizon), do nome do seu container e do nome do seu objeto (incluindo o prefixo).
