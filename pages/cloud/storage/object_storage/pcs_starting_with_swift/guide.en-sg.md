...
- Preparing the environment to [use the OpenStack API](https://docs.ovh.com/sg/en/public-cloud/prepare_the_environment_for_using_the_openstack_api) by installing *python-swiftclient*
- Setting the [OpenStack environment variables](https://docs.ovh.com/sg/en/public-cloud/set-openstack-environment-variables)
...
This URL is made up of an endpoint, available from the [Horizon interface](https://docs.ovh.com/sg/en/public-cloud/access_and_security_in_horizon), the name of your container and the name of your object (including the prefix).
