...
- [Prepare the environment to use the OpenStack API](https://docs.ovh.com/sg/en/storage/public-cloud/prepare_the_environment_for_using_the_openstack_api)
- [Get the Openstack RC File v3 from Horizon](https://docs.ovh.com/sg/en/storage/public-cloud/set-openstack-environment-variables)
