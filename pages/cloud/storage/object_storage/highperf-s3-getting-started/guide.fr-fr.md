---
title: Object Storage - Premiers pas avec AWS CLI
...
- Vous aurez également besoin de votre *url_endpoint*. Si vous avez déjà créé votre bucket, cette information est accessible depuis l'onglet `Mes conteneurs` puis dans les détails du votre bucket. Autrement, suivez ce [guide](https://docs.ovh.com/fr/storage/object-storage/s3/location).
