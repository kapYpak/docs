...
slug: methode_optimisee_pour_le_telechargement_de_fichiers_vers_object_storage
...
- [Préparer l'environnement pour utiliser l'API OpenStack](../../public-cloud/preparer-lenvironnement-pour-utiliser-lapi-openstack/) avec le client python-swiftclient.
